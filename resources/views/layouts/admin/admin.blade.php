  ...
  <div class="d-flex" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="{{url('/admin/product')}}" class="list-group-item list-group-item-action bg-light">Product</a>
        <a href="{{url('/admin/category')}}" class="list-group-item list-group-item-action bg-light">menu</a>
